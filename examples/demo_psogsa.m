...
fprintf('========================================\n');
fprintf('Hybrid PSO-GSA Algorithm (PSOGSA) Demo\n');
fprintf('========================================\n\n');
...
fprintf('  Inertia Weight: [%.1f, %.1f]\n', config.wMin, config.wMax);
fprintf('  Gravitational Constant G0: %.1f\n\n', config.G0);
...
%% 5. 运行PSOGSA优化
fprintf('Running PSOGSA optimization...\n\n');
...
subplot(1, 2, 2);
result.plotConvergence('Title', 'PSOGSA Convergence Curve', 'Scale', 'log');

sgtitle(sprintf('PSOGSA Optimization Results - %s', Function_name), ...
