...
fprintf('========================================\n');
fprintf('Grey Wolf Optimizer (GWO) Demo\n');
fprintf('========================================\n\n');
...
%% 5. 运行GWO优化
fprintf('Running GWO optimization...\n\n');
...
% 子图2: 收敛曲线
subplot(1, 2, 2);
result.plotConvergence('Title', 'GWO Convergence Curve', 'Scale', 'log');

sgtitle(sprintf('GWO Optimization Results - %s', Function_name), ...
