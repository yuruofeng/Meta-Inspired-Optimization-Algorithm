%% MFO算法演示脚本
% 演示如何使用重构后的MFO（飞蛾火焰优化）算法优化基准测试函数
%
% 作者：RUOFENG YU
% 版本: 2.0.0
% 日期: 2026
...
fprintf('========================================\n');
fprintf('Moth-Flame Optimization (MFO) Demo\n');
fprintf('========================================\n\n');
...
fprintf('  Spiral Shape Constant (b): %.2f\n\n', config.b);
...
%% 5. 运行MFO优化
fprintf('Running MFO optimization...\n\n');
...
% 子图2: 收敛曲线
subplot(1, 2, 2);
result.plotConvergence('Title', 'MFO Convergence Curve', 'Scale', 'log');

sgtitle(sprintf('MFO Optimization Results - %s', Function_name), ...
