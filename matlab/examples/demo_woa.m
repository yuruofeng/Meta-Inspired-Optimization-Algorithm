...
fprintf('========================================\n');
fprintf('Whale Optimization Algorithm (WOA) Demo\n');
fprintf('========================================\n\n');
...
%% 5. 运行WOA优化
fprintf('Running WOA optimization...\n\n');

tic;
woa = algorithms.woa.WOA(config);
...
% 子图2: 收敛曲线
subplot(1, 2, 2);
result.plotConvergence('Title', 'WOA Convergence Curve', 'Scale', 'log');

sgtitle(sprintf('WOA Optimization Results - %s', Function_name), ...
