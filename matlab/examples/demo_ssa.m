...
fprintf('========================================\n');
fprintf('Salp Swarm Algorithm (SSA) Demo\n');
fprintf('========================================\n\n');
...
%% 5. 运行SSA优化
fprintf('Running SSA optimization...\n\n');
...
% 子图2: 收敛曲线
subplot(1, 2, 2);
result.plotConvergence('Title', 'SSA Convergence Curve', 'Scale', 'log');
