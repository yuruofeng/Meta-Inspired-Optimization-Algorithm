    ...
    methods (Access = protected)
        function initOperators(obj)
            ...
            switch obj.config.selection
                case 'tournament'
                    obj.selectionOperator = TournamentSelection(...
                        obj.config.tournamentSize);
                case 'roulette'
                    obj.selectionOperator = RouletteWheelSelection();
                otherwise
                    obj.selectionOperator = TournamentSelection(3);
            end

            % 交叉算子
            switch obj.config.crossover
                case 'uniform'
                    obj.crossoverOperator = UniformCrossover(...
            ...
            switch obj.config.mutation
                case 'gaussian'
                    obj.mutationOperator = GaussianMutation(...
