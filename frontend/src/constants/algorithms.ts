...
// 多目标算法颜色映射
export const LEGACY_MO_ALGORITHM_COLORS: Record<string, string> = {
  MOALO: '#FF6B6B',
  MODA: '#4ECDC4',
  MOGOA: '#45B7D1',
  MOGWO: '#96CEB4',
...
export function getAlgorithmColor(algorithmId: string): string {
  return ALGORITHM_COLORS[algorithmId] || LEGACY_MO_ALGORITHM_COLORS[algorithmId] || '#6B7280';
}
...
export const ALGORITHMS: Algorithm[] = [
  ...
  {
    id: 'MOALO',
    name: 'Multi-Objective Ant Lion Optimizer',
    shortName: 'MOALO',
    fullName: 'Multi-Objective Ant Lion Optimizer',
    version: '1.0.0',
    description: 'Multi-objective ant lion optimizer fallback entry.',
    category: 'swarm',
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
    },
    complexity: { time: 'O(MaxIter x N x Dim)', space: 'O(N x Dim)' },
  },
  {
    id: 'MODA',
    name: 'Multi-Objective Dragonfly Algorithm',
    shortName: 'MODA',
    fullName: 'Multi-Objective Dragonfly Algorithm',
    version: '1.0.0',
    description: 'Multi-objective dragonfly optimizer fallback entry.',
    category: 'swarm',
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
  ...
  {
    id: 'MOGOA',
    name: 'Multi-Objective Grasshopper Optimization Algorithm',
    shortName: 'MOGOA',
    fullName: 'Multi-Objective Grasshopper Optimization Algorithm',
    version: '1.0.0',
    description: 'Multi-objective grasshopper optimizer fallback entry.',
    category: 'swarm',
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
  ...
  {
    id: 'MOGWO',
    name: 'Multi-Objective Grey Wolf Optimizer',
    shortName: 'MOGWO',
    fullName: 'Multi-Objective Grey Wolf Optimizer',
    version: '1.0.0',
    description: 'Multi-objective grey wolf optimizer fallback entry.',
    category: 'swarm',
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
  ...
  {
    id: 'MSSA',
    name: 'Multi-Objective Salp Swarm Algorithm',
    shortName: 'MSSA',
    fullName: 'Multi-Objective Salp Swarm Algorithm',
    version: '1.0.0',
    description: 'Multi-objective salp swarm optimizer fallback entry.',
    category: 'swarm',
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
  ...
  {
    id: 'NSGAIII',
    name: 'Non-dominated Sorting Genetic Algorithm III',
    shortName: 'NSGA-III',
    fullName: 'Non-dominated Sorting Genetic Algorithm III',
    version: '1.0.0',
    description: 'Reference-point-based multi-objective genetic algorithm fallback entry.',
    category: 'evolutionary',
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
    },
    complexity: { time: 'O(MaxIter x N^2)', space: 'O(N x Dim)' },
  },
  {
    id: 'MOEAD',
    ...
    version: '1.0.0',
    description: 'Decomposition-based multi-objective evolutionary optimizer fallback entry.',
    category: 'evolutionary',
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'Parameter-light optimizer that moves candidates toward the best and away from the worst solution.',
    category: 'evolutionary',
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
  ...
  },
  {
    ...
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
      frequencyMin: { type: 'float', default: 0, min: 0, description: 'Minimum frequency' },
      frequencyMax: { type: 'float', default: 2, min: 0, description: 'Maximum frequency' },
    },
    reference: {
      authors: 'X. S. Yang',
      year: 2010,
  ...
  },
  {
    ...
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
      switchProbability: { type: 'float', default: 0.8, min: 0, max: 1, description: 'Global pollination probability' },
    },
    reference: {
      authors: 'X. S. Yang',
      year: 2012,
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'Music improvisation-inspired optimizer using harmony memory and pitch adjustment.',
    category: 'physics',
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 5, max: 10000, description: 'Harmony memory size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
      harmonyMemoryConsideringRate: { type: 'float', default: 0.9, min: 0, max: 1, description: 'Harmony memory considering rate' },
      pitchAdjustingRate: { type: 'float', default: 0.3, min: 0, max: 1, description: 'Pitch adjusting rate' },
    },
    reference: {
  ...
  },
  {
    ...
    category: 'swarm',
    paramSchema: {
      populationSize: { type: 'integer', default: 30, min: 6, max: 10000, description: 'Population size' },
      maxIterations: { type: 'integer', default: 500, min: 1, max: 100000, description: 'Maximum iterations' },
      stepSize: { type: 'float', default: 0.1, min: 0, description: 'Chemotactic step size' },
    },
    reference: {
      authors: 'K. M. Passino',
      year: 2002,
