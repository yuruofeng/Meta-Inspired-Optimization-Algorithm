...
class MatlabBridge:
    ...
    def __init__(self, matlab_path: Optional[str] = None):
        ...
        self.matlab_path = matlab_path or os.path.join(repo_root, "matlab")
        self.executor = ThreadPoolExecutor(max_workers=4)
        self._lock = threading.Lock()
        self._connected = False
        force_simulation = os.getenv("MOA_SIMULATION_MODE", "").lower() in {
            "1",
            "true",
            "yes",
            "on",
        }
        self._simulation_mode = force_simulation or not MATLAB_AVAILABLE
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            if self.eng:
                # 添加项目路径到MATLAB
                self.eng.addpath(self.eng.genpath(self.matlab_path), nargout=0)
        ...
        return [
            {
                ...
                "upperBound": 100,
                "optimalValue": 0,
                "description": "Sphere benchmark function",
            },
            {
                "id": "F2",
                "name": "Rosenbrock",
                ...
                "upperBound": 30,
                "optimalValue": 0,
                "description": "Rosenbrock benchmark function",
            },
            {
                "id": "F9",
                "name": "Rastrigin",
                ...
                "upperBound": 5.12,
                "optimalValue": 0,
                "description": "Rastrigin benchmark function",
            },
        ]
